  ...
  return (
    <div className="pb-32 pt-24 bg-white">
      <div className="container mx-auto px-6 max-w-4xl">
        <h1 className="text-5xl font-black mb-12 text-near-black">Policies & Legal</h1>
        
        <div className="space-y-16">
          <section className="bg-white border border-brand-light p-12 rounded-[3rem]">
            <h2 className="text-3xl font-bold mb-6 text-brand-blue">Age Restriction Policy</h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p className="text-near-black font-bold text-xl mb-4">You must be 21 years or older to purchase any products from Cloud9 Smoke Shop.</p>
          ...
          <section className="space-y-12">
            <div>
              <h2 className="text-2xl font-bold mb-4 text-near-black">Privacy Policy</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4 text-near-black">Terms & Conditions</h2>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-4 text-near-black">Return Policy</h2>
              <p className="text-gray-600 leading-relaxed">
